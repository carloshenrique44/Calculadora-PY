...
root.geometry("415x360")
root.maxsize(415,360)
root.minsize(415,360)


root.configure(background='#282828')

e = Entry(root, width=15, borderwidth=4, relief=FLAT, fg='#000000',
          bg='#b8860b', font=('futura', 25, 'bold'), justify=CENTER)
e.grid(
    row=0,
    column=0,
    columnspan=4,
